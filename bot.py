...
# تنظیمات - اینجا رو بعداً در Railway پر می‌کنیم
TOKEN = os.environ.get("TOKEN", "YOUR_BOT_TOKEN")  # توکن از محیطی میاد
ADMIN_ID = int(os.environ.get("ADMIN_ID", "123456789"))  # آیدی از محیطی میاد
...
DEFAULT_SETTINGS = {
    ...
    "auto_messages": [
        "سلام",  # می‌تونی این رو عوض کنی
        "درود",  # یا هر متن دیگه‌ای
        "چطوری؟",
        "خوبی؟",
        "چه خبر؟",
        "چکار می‌کنی؟",
